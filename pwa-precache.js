...
self.PWA_PRECACHE_URLS = [
  ...
  "components/td-arena.js",
  "components/td-arena.js?v=4",
  "components/td-build-panel.js",
  "components/td-build-panel.js?v=1",
  ...
  "styles/lobby-roster-float.css?v=2",
  "styles/lobby.css",
  ...
  "systems/synergy.js",
  "systems/td-engine.js",
  "systems/td-engine.js?v=5",
