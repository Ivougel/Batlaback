...
**Единственный игровой каталог** — **120 предметов** (+ `starter_bag` для стартового рюкзака). Полный legacy-каталог (~308) архивирован в `tools/items-migrated-legacy.json`.
...
| Рюкзак (магазин) | 68 | оружие, еда, яд, магия, броня… |
...
| Файл | Назначение |
|------|------------|
| `tools/items-migrated.json` | **78** записей: 77 из пула + `starter_bag` |
...
- Пресеты: AI prep по `AI_ARCHETYPES[classId]`, магазин **только pool v120**, win-streak до R1/R8/R16
