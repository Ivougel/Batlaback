...
(function initSfxThemes(global) {
  ...
  const SOUND_THEME_META = {
    classic: {
      id: "classic",
      label: "Стандарт",
      hint: "Сбалансированный набор: ровные тона в меню и чёткие удары в бою.",
      emoji: "🎮",
    },
    dopamine: {
      id: "dopamine",
      label: "Искра",
      hint: "Восходящие ноты и блеск на покупках — каждое действие звучит как маленькая награда.",
      emoji: "✨",
    },
    gentle: {
      id: "gentle",
      label: "Тишина",
      hint: "Мягкие колокольчики в спокойном ритме — для неторопливой игры.",
      emoji: "🌸",
    },
    meat: {
      id: "meat",
      label: "Тяжесть",
      hint: "Глухие удары, вязкие клики и плотный звук попаданий.",
      emoji: "🥩",
    },
    mirror: {
      id: "mirror",
      label: "Стекло",
      hint: "Тонкие клики интерфейса: отклик на наведение, тап и каждый переход.",
      emoji: "📱",
    },
    forest: {
      id: "forest",
      label: "Лес",
      hint: "Шелест листвы, орех на мох и приглушённые удары без ярких верхов.",
      emoji: "🌳",
    },
  };
